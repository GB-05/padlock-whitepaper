...
aren't using it, and don't need to have an expensive GPU. This also has the
added benefit of being more power efficient, which will make PADLOCK more
environmentally-friendly when compared to other cryptocurrencies.
